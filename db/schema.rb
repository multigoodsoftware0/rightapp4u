...
ActiveRecord::Schema.define(version: 2019_02_23_062405) do
  ...
  create_table "order_product_licenses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "order_id"
  ...
  create_table "products", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.text "tldr"
    t.text "benefits"
    t.integer "total_licenses_available"
    t.boolean "published"
    t.string "name"
  end
